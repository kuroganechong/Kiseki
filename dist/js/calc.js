...
var post=Vue.component('hero',{props:['post','hero'],data:function(){return{c:0}},template:'<div v-if="(post.ally == 1 && post.id != hero) || (post.ally != 1 && post.id == hero)">\
                ...
                </div>',methods:{selUW:function(id){data=document.getElementById(id).value
data=data.split(",")
...
if(newdata[0]!=""){this.$emit('clickedt5',newdata)}else{this.$emit('clickedt5',[0,0,0])}}},selUT:function(id,utno){data=document.getElementById(id).value
data=data.split(",")
...
break}}}
return x}}})
app=new Vue({el:'#app',data:{cl:'1',statatk:0,statcdmg:0,statpen:0,art_1:0,art_2:0,art_3:0,scale:0,addatk:0,addcdmg:0,Fa:0,skillatk:0,skillcdmg:0,skillfa:0,hero:hash,uwtemp:{},uttemp:{},posts:jsonval,heronames:heronames,perk1:!1,perk2:[],wa2:0,obs:0,heroscale:1},computed:{perkatk:function(){var x=0
...
return x},pref:function(){var x=0
...
return Math.round(x)}},components:{post:post},methods:{reset:function(){window.location.href="calc.html#"+this.hero
